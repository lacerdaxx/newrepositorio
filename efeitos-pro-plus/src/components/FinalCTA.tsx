...
export default function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-ink-950 py-24 lg:py-32">
      <div className="pointer-events-none absolute left-1/2 top-1/2 h-[500px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gold-500/20 blur-[160px]" />
      ...
      <div className="container-px relative mx-auto max-w-3xl text-center">
        <Reveal>
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
            SEUS VÍDEOS PODEM <span className="text-gradient-gold">IR ALÉM</span>.
          </h2>
        </Reveal>
