      ...
      <div className="container-px mx-auto max-w-6xl">
        <Reveal className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl lg:text-5xl">
            FEITO PARA QUEM <span className="text-gradient-gold">CRIA CONTEÚDO</span>.
          </h2>
        </Reveal>
        ...
        <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {AUDIENCE.map((a, i) => (
            <Reveal key={a.title} delay={i * 70} className={i === 4 ? "sm:col-span-2 lg:col-span-1" : ""}>
              <div className="flex h-full flex-col items-start gap-3 rounded-2xl border border-white/10 bg-white/[0.02] p-6 transition-all duration-300 hover:-translate-y-1 hover:border-gold-500/25">
